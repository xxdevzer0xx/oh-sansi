...
const BoletaInfo: React.FC<Props> = ({componentRef, estudiantes , costoTotalGeneral, encargado, numeroOrden,codigoBoleta}) => {
  ...
  <div ref={componentRef} className="p-6 bg-white border border-black w-[800px] mx-auto text-[14px]">
    ...
    {/* Mostrar lista detallada o resumen según cantidad de estudiantes */}
