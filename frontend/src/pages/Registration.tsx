...
import type { Student, CompetitionArea, RegistrationSummary, Grade, Level, FormFieldConfig } from '../types';
...
export function Registration() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const configResponse = await axios.get(`${API_BASE_URL}/registration/fields-config`);
        setFieldConfig(Array.isArray(configResponse.data) ? configResponse.data : []);

        // Cargar datos de áreas, grados y niveles
        ...
        if (areasResponse.data.status === 'success') {
          ...
          const areasWithCostos: CompetitionArea[] = areasData.map((area: any) => {
            ...
            const nivel = areaCosto && nivelesData.length > 0 ? 
  ...
  const validateForm = () => {
    ...
    // Validación basada en fieldConfig si está activo
  ...
  const renderField = (fieldKey: string, label: string, type = 'text') => {
    if (fieldConfig.length === 0) return null;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      try {
        ...
        const competidorId = competidorResponse.data.Id_competidor;
        ...
        setErrors({ submit: `Hubo un error al procesar tu inscripción: ${errorMessage}. Por favor, intenta nuevamente.` });
      }
    }
  };
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              {fieldConfig.length > 0 ? (
                <>
                  ...
                  {renderField('colegio', 'Unidad Educativa')}
                </>
              ) : (
                <>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="ci"
                      value={formData.ci}
                      onChange={(e) => handleStudentFieldChange('ci', e.target.value)}
                      className={`mt-1 block w-full rounded-md shadow-sm ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleStudentFieldChange('colegio', e.target.value)}
                      className={`mt-1 block w-full rounded-md shadow-sm ${
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleStudentFieldChange('gradeId', e.target.value)}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleStudentFieldChange('departamento', e.target.value)}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleStudentFieldChange('provincia', e.target.value)}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-700 border-b pb-2">Niveles de Competencia</h3>
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleGuardianFieldChange('name', e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleGuardianFieldChange('email', e.target.value)}
                      className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleGuardianFieldChange('phone', e.target.value)}
                      className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
